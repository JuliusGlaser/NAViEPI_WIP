...
print('> coil: ' + '/home/hpc/iwbi/iwbi019h/DeepSubspaceMRI/deepsubspacemri/data_files/phantom_ms_qti/meas_MID00179_FID09425_ep2d_diff_qti_gufi/coils_reord.h5')
f = h5py.File('/home/hpc/iwbi/iwbi019h/DeepSubspaceMRI/deepsubspacemri/data_files/phantom_ms_qti/meas_MID00179_FID09425_ep2d_diff_qti_gufi/coils_reord.h5', 'r')
coil = f['coil'][:]
f.close()
...
f = h5py.File('/home/hpc/iwbi/iwbi019h/DeepSubspaceMRI/deepsubspacemri/data_files/phantom_ms_qti/meas_MID00179_FID09425_ep2d_diff_qti_gufi/kdat_slice_000.h5', 'r')
MB = f['MB'][()]
N_slices = f['Slices'][()]
...
for s in slice_loop:
    ...
    f = h5py.File('/home/hpc/iwbi/iwbi019h/DeepSubspaceMRI/deepsubspacemri/data_files/phantom_ms_qti/meas_MID00179_FID09425_ep2d_diff_qti_gufi/kdat_slice_' + slice_str + '.h5', 'r')
    kdat = f['kdat'][:]
    f.close()
    ...
    if args.muse is True:
        ...
        f = h5py.File('/home/hpc/iwbi/iwbi019h/DeepSubspaceMRI/deepsubspacemri/classic_recon/' + recon_file, 'w')
    ...
    if (args.jets is True) and (N_segments > 1):
        ...
        for s in range(args.split):
            ...
            acs_shape = acs_shape = [N_y // 4, N_x // 4]
            ...
            red_shape = ([N_y // args.reduce, N_x // args.reduce])
